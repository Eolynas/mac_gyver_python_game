...
def main():
    ...
    mac_gyver.display_mac_gyver(display_windows)
    ...
    while continuer:
        ...
        items_1.display_aiguille(display_windows)
        items_2.display_ether(display_windows)
        items_3.display_tube(display_windows)
